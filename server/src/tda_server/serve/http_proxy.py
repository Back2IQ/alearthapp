...
from tda_server.adapters.afad import AFAD_TZ, AFAD_URL, parse_afad_response
from tda_server.adapters.gdacs import GDACS_URL, parse_gdacs_feed
from tda_server.domain.hazards import hazard_confidence
