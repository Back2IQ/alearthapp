...
class AlarmService : Service() {
    ...
    companion object {
        const val ACTION_ARM = "app.alert2iq.ARM"
        const val ACTION_USER_SAFE = "app.alert2iq.USER_SAFE"
        const val ACTION_USER_HELP = "app.alert2iq.USER_HELP"
        const val ACTION_STOP = "app.alert2iq.STOP"
